...
/**
 * crea los action listener para el funcionamiento de los botones
...
public class Controller  implements ActionListener {
	...
	/**
	 * asigna los action listener para los botones
	 */
	...
	@Override
	/**
	 * depeniendo del poton que preciono para que el oyente diera el parametro
	 * se si se cumple uno de los if entonces pasa un JOption pane con la funcion
	 * requerida.
	 */
